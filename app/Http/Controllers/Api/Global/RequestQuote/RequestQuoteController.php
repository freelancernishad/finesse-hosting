...
class RequestQuoteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'categories.*.id' => 'required|exists:job_categories,id', // Ensure each category id exists in job_categories
            'categories.*.name' => 'required|string|max:255', // Ensure name is provided and is a string
            'categories.*.count' => 'required|integer|min:1', // Ensure count is provided and is a valid integer
